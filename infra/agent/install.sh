...
for capability in artifactRetention buildArgs buildGuardrails continuousHealth managedIngress managedRedis nodeCapacity nodeDiskMetrics persistentVolumes privateNetworking resourceGuardrails runtimeMetrics; do
