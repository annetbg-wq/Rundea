...
for capability in artifactRetention buildArgs buildGuardrails continuousHealth managedIngress nodeCapacity nodeDiskMetrics resourceGuardrails runtimeMetrics; do
