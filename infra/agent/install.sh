...
for capability in artifactRetention buildArgs buildGuardrails continuousHealth managedIngress managedRedis nodeCapacity nodeDiskMetrics nodeMaintenance persistentVolumes privateNetworking resourceGuardrails runtimeMetrics; do
