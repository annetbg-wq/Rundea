...
export const requiredAgentCapabilities = ["artifactRetention", "buildArgs", "buildGuardrails", "managedIngress", "nodeCapacity", "resourceGuardrails", "runtimeMetrics"] as const;
